...
SECRET_KEY = 'django-insecure-20!l@gh$qpixwx)ra!x*2=*^cxujw$7ec9gbzebae%3-x*xc0s'
...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME' : "drznhdwq4",
    'API_KEY' : "168425791841985",
    'API_SECRET' : "1H4-2PGeaPmb7X2e7t2VlCzOb_M",
}
